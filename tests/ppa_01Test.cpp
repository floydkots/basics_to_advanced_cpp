...
namespace {
    class ppa_01Test : public testing::Test {
    public:
        ppa_01 ppa01;
...
TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo0_Test) {
    int ageResult;
...
TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultToNegativeOne_Test) {
    int ageResult;
    ppa01.detectAgeResult(-1, ageResult);
...
TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo1_Test) {
    int ageResult;
    ppa01.detectAgeResult(6, ageResult);
    ppa01.detectAgeResult(12, ageResult);
    ASSERT_EQ(1, ageResult);

}TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo2_Test) {
    int ageResult;
...
TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo3_Test) {
    int ageResult;
    ppa01.detectAgeResult(50, ageResult);
    ASSERT_EQ(3, ageResult);
}

TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo4_Test) {
    int ageResult;
    ppa01.detectAgeResult(51, ageResult);
    ASSERT_EQ(4, ageResult);
}

TEST_F(ppa_01Test, ppa_01Test_shouldSetAgeResultTo5_Test) {
    int ageResult;
